...
Project: Thompson and Birchtree mines, Thompson, MB, Canada (NiPERA, Univ. of Michigan)
...
# Birch Surface
barplot(BirchNi[1:3,],las=1,ylab="Sediment Ni (mg/kg)",ylim=c(0,600))
box()
...
# Weir Surface
barplot(WeirNi[1:3,],las=1,ylab="Sediment Ni (mg/kg)",ylim=c(0,600))
box()
