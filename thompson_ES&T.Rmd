...
##Relationship between Total Ni and Cond w/ and w/o Cond sites > 4000 (n=2)
  plot(TotalNi.surf~Cond,chem.inv.exp)
  abline(lm(TotalNi.surf~Cond,chem.inv.exp[chem.inv.exp$Cond<4000,]),col=2) #Best-fit line for model without Cond>4000
  summary(lm(TotalNi.surf~Cond,chem.inv.exp))
  
  plot(TotalNi.surf~Cond,chem.inv.exp[chem.inv.exp$Cond<4000,])
  abline(lm(TotalNi.surf~Cond,chem.inv.exp[chem.inv.exp$Cond<4000,]),col=2)
  summary(lm(TotalNi.surf~Cond,chem.inv.exp[chem.inv.exp$Cond<4000,]))
```
_____
